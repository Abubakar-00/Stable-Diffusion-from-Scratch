...
#         super().__init__()
#         # (1, 320) -> (1, 1280)
#         self.linear_1 = nn.Linear(n_embd, 4 * n_embd) # 4 times projection 
#         self.linear_2 = nn.Linear(4 * n_embd, 4 * n_embd)
...
#     def forward(self, feature, time):
#         # feature: (Batch_Size, In_Channels, Height, Width) <- Latent
#         # time (1, 1280)
...
#         x, gate = self.linear_geglu_1(x).chuck(2, dim=1)
#         x = x * F.gelu(gate)
...
#         # Central part of the UNET, combining residual blocks and attention mechanisms
